...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@Smu1bot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "leechunzip@Smu1bot")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "leechzip@Smu1bot")
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "gleech@Smu1bot")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "gleechunzip@Smu1bot")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "gleechzip@Smu1bot")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@smu1bot")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdl@Smu1bot")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "TorrentLeech-Gdrive")
INDEX_LINK = os.environ.get("INDEX_LINK", "")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "tleech@Smu1bot")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", "tleechunzip@Smu1bot"
)
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel@Smu1bot")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsize@Smu1bot")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@Smu1bot")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumbnail@Smu1bot")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumbnail@Smu1bot")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdl@DSmu1bot")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "gpytdl@Smu1bot")
LOG_COMMAND = os.environ.get("LOG_COMMAND", "log@Smu1bot")
CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "gclone@Smu1bot")
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "upload@Smu1bot")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "renewme@Smu1bot")
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename@Smu1bot")
TOGGLE_VID = os.environ.get("TOGGLE_VID", "togglevid@Smu1bot")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "toggledoc@Smu1bot")
RCLONE_COMMAND = os.environ.get("RCLONE_COMMAND", "rclone")
HELP_COMMAND = os.environ.get("HELP_COMMAND", "helps")
